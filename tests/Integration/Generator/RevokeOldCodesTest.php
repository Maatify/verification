...
final class RevokeOldCodesTest extends DatabaseTestCase
{
    ...
    public function test_revoke_all_for_keeps_newest_codes_only(): void
    {
        $this->pdo->exec("
            ...
            (3, 'user', 'user123', 'email_verification', 'hash3', 'active', 0, 3, '2024-01-01 12:10:00', '2024-01-01 11:55:00')
        ");
        ...
        $this->assertEquals('revoked', $rows[2]['status']);
